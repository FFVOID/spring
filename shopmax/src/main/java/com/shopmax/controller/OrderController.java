...
public class OrderController {
	...
	public @ResponseBody ResponseEntity order(@RequestBody @Valid OrderDto orderDto,
			BindingResult bindingResult, Principal principal) { //principal -> 로그인한 사용자의 정보를 가져올수있다
	...
	public String orderHist(OrderHistDto orderHistDto, @PathVariable("page") Optional<Integer> page, Principal principal, Model model) {
		
		
		//1.한페이지 당 4개의 데이터를 가지고 온다
